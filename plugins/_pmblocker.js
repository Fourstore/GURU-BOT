...
export async function before(m, { conn, isAdmin, isBotAdmin, isOwner, isROwner }) {
    ...
    if (!m.isGroup) {
      ...
      if (bot.pmblocker && !isOwner && !isROwner) {
        ...
        await m.reply(`*Halo @${m.sender.split`@`[0]}, mengirim pesan ke bot secara pribadi saat ini dinonaktifkan. Anda telah diblokir untuk menggunakan bot.*`, false, { mentions: [m.sender] });
